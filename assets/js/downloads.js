document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateDownloadLink() {
        ...
        let targetSelector = "";
        if (currentOS === "win") targetSelector = ".hidden-links #dl-win, .hidden-links #pdftrim-dl-win, .hidden-links #downloader-dl-win, .hidden-links #sync-dl-win";
        else if (currentOS === "mac") targetSelector = ".hidden-links #dl-mac, .hidden-links #pdftrim-dl-mac, .hidden-links #downloader-dl-mac, .hidden-links #sync-dl-mac";
        else if (currentOS === "lin") targetSelector = ".hidden-links #" + currentLinuxFormat +", .hidden-links #pdftrim-" + currentLinuxFormat + ", .hidden-links #downloader-" + currentLinuxFormat + ", .hidden-links #sync-" + currentLinuxFormat;
