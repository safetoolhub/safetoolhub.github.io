    ...
    function updateDownloadLink() {
        ...
        if (linkElement && linkElement.href) {
            ...
            if (currentOS === "win") {
                ...
                dlActionBtn.innerHTML = `<span><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right: 8px;"><polyline points="4 17 10 11 4 5" /><line x1="12" y1="19" x2="20" y2="19" /></svg> <span data-i18n="modal-dl-btn">Download for</span> Linux (${linuxLabel})</span>`;
            }
