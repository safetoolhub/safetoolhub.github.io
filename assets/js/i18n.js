...
const translations = {
  en: {
    ...
    "tools-p-badge": "v0.5.0-beta",
    "tools-p-title": "SafeTool PDF",
    "tools-p-desc": "A simple and powerful PDF optimizer that reduces file size without compromising quality. Focused on one task: making your PDFs smaller.",
    "tools-p-f1": "High-ratio size reduction",
    "tools-p-f2": "Strictly reduces PDFs (it does not split or combine them)",
    "tools-p-f3": "100% local and private processing",
    ...
    "footer-links-pdftrim": "SafeTool PDF Repo",
  ...
  es: {
    ...
    "tools-p-badge": "v0.5.0-beta",
    "tools-p-title": "SafeTool PDF",
    "tools-p-desc": "Un optimizador de PDFs sencillo y potente que reduce el tamaño del archivo sin comprometer la calidad. Enfocado en una sola tarea: hacer tus PDFs más pequeños.",
    "tools-p-f1": "Reducción de tamaño de alta eficiencia",
    "tools-p-f2": "Simplemente reduce PDF (no los divide o combina)",
    "tools-p-f3": "Procesamiento 100% local y privado",
    ...
    "footer-links-pdftrim": "Repo de SafeTool PDF",
